export default {
    title: "Flor iluminada en rojo",
    text : 
    `
    Unas manos la empujaron al vació y cayó a algo que parecía agua junto a multitud de
    cuerpos que aterrizaron a su alrededor. Pero mientras se ahogaba en el líquido, los
    demás se marcharon hacia la luz.

    La mujer se levantó y siguió a sus compañeros. Descubrió que estaba en unas
    alcantarillas, con túneles que se multiplicaban y que terminaban en agujeros negros que
    devoraban todo lo que tocaban. Escuchó gritos y sonidos de lucha en la distancia, que
    utilizo cómo guía para elegir los túneles correctos y evitar así la oscuridad. Pero al girar
    una esquina, rozó una parte oscura y de un charco, una sombra saltó hacia ella.
    La figura estaba armada con un cuchillo que dirigió hacia su garganta. Sus manos se
    movieron con rapidez y detuvo el filo blanco. Pero la sombra era más grande y pesada,
    ...
    su boca, se afilaron y la oscuridad comenzó a huir de ella. También empezó a oír con más
    claridad el sonido de la batalla y se apresuró a llegar hasta su origen.
    A medida que se transformaba, el hacha comenzó a pesar menos hasta el punto en que
